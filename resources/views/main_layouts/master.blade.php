...
<body>
  ...
  <div id="page">
            ...
            <div class="col-md-10 text-right menu-1">
              <ul>
                ...
                <li class="has-dropdown">
                  ...
                  <ul class="dropdown">
                    <li>
                      <a onclick="event.preventDefault(); document.getElementById('nav-logout-form').submit()" href="">Logout
                      </a>
    ...
    <div id="colorlib-subscribe" class="subs-img" style="background-image: url(blog_template/images/img_bg_2.jpg);"
          ...
          <div class="row">
            <div class="col-md-12 text-center">
              <p>
                ...
                <small class="block">Demo Images: <a href="http://unsplash.co/" target="_blank">Unsplash</a>, <a
